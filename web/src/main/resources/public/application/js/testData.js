...
query11.queryTargetType(new ElasticQueryTargetType());
query11.queryTargetType().id('Test134');
query11.queryTargetType().index('_all');
query11.queryTargetType().type('status');
query11.size(10);
...
query21.queryTargetType(new ElasticQueryTargetType());
query21.queryTargetType().index('my_twitter_river');
query21.queryTargetType().type('status');
query21.queryTargetType().id('Test134');
query21.field("text");
query21.size(10);
